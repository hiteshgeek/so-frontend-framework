<div class="so-tab-pane so-fade" id="pane-complete-forms" role="tabpanel">
    <div class="so-card">
        <div class="so-card-header">
            <h3 class="so-card-title">Complete Form Examples</h3>
            <p class="so-card-subtitle">Real-world form examples combining various components.</p>
        </div>
        <div class="so-card-body">

            <!-- Login Form -->
            <h4 class="so-demo-section-title">Login Form</h4>
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Registration Form -->
            <h4 class="so-demo-section-title">Registration Form</h4>
            <div class="so-example-block">
                <div class="so-example-preview">
...
&lt;/div&gt;</code></pre>
            ...
            <!-- Contact Form -->
            <h4 class="so-demo-section-title">Contact Form</h4>
            <div class="so-example-block">
                <div class="so-example-preview">
                        ...
                        <div class="so-form-card-body">
                            <form>
                                ...
                                <div class="so-form-group">
                                    ...
                                    <textarea class="so-form-control" rows="5" placeholder="How can we help you?" maxlength="500" data-char-counter="500" data-counter-target="#contactCounter"></textarea>
            ...
            <h4 class="so-demo-section-title">Settings Form (Horizontal)</h4>
            <div class="so-example-block">
                <div class="so-example-preview">
            ...
            <!-- Checkout Form -->
            <h4 class="so-demo-section-title">Checkout Form</h4>
            <div class="so-example-block">
                <div class="so-example-preview">
                    <div class="so-form-card" style="max-width: 600px; margin: 0 auto;">
                        <div class="so-form-card-header">
